 ...
 * 
 */
@WebServiceClient(name = "MyCalculatorService", targetNamespace = "http://service.document.soap.com/", wsdlLocation = "http://localhost:9999/MyCalculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYCALCULATORSERVICE_QNAME = new QName("http://service.document.soap.com/", "MyCalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/MyCalculator?wsdl");
    ...
    public Calculator getMyCalculatorPort() {
        return super.getPort(new QName("http://service.document.soap.com/", "MyCalculatorPort"), Calculator.class);
    }
     ...
     */
    @WebEndpoint(name = "MyCalculatorPort")
    public Calculator getMyCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.document.soap.com/", "MyCalculatorPort"), Calculator.class, features);
    }
